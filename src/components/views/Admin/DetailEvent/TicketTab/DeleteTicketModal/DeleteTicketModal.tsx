...
const DeleteTicketModal = ({
  ...
  const { mutateDeleteTicket, isPendingMutateDeleteTicket, isSuccessMutateDeleteTicket } = useDeleteTicketModal();
    ...
    <Modal onOpenChange={onOpenChange} isOpen={isOpen} placement="center" scrollBehavior="inside">
      <ModalContent className="m-4">
        ...
        <ModalFooter>
          ...
          >
            {isPendingMutateDeleteTicket ? <Spinner size="sm" color="white" /> : "Delete Ticket"}
          </Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
