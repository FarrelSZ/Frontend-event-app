...
const useCoverTab = () => {
  const { handleUploadFile, isPendingMutateUploadFile, handleDeleteFile, isPendingMutateDeleteFile } =
    useMediaHandling();
  ...
  const handleUploadCover = (files: FileList, onChange: (files: FileList | undefined) => void) => {
