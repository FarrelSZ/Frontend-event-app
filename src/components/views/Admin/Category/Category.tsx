...
const Category = () => {
  ...
  const { dataCategory, isLoadingCategory, isRefetchingCategory, refetchCategory, selectedId, setSelectedId } =
    useCategory();
    ...
    (category: Record<string, unknown>, columnKey: Key) => {
      ...
      switch (columnKey) {
        case "icon":
          ...
          return <Image src={iconSrc} alt="icon" width={100} height={200} loading="lazy" />;
        case "actions":
          return (
            <DropdownAction
