...
const DeleteCategoryModal = ({
  ...
  const { mutateDeleteCategory, isPendingMutateDeleteCategory, isSuccessMutateDeleteCategory } =
    ...
    <Modal onOpenChange={onOpenChange} isOpen={isOpen} placement="center" scrollBehavior="inside">
      <ModalContent className="m-4">
        ...
        <ModalFooter>
          ...
          >
            {isPendingMutateDeleteCategory ? <Spinner size="sm" color="white" /> : "Delete Category"}
          </Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
