...
const DeleteEventModal = ({ isOpen, onClose, onOpenChange, selectedId, setSelectedId, refetchEvent }: PropTypes) => {
  const { mutateDeleteEvent, isPendingMutateDeleteEvent, isSuccessMutateDeleteEvent } = useDeleteEventModal();
    ...
    <Modal onOpenChange={onOpenChange} isOpen={isOpen} placement="center" scrollBehavior="inside">
      <ModalContent className="m-4">
        ...
        <ModalFooter>
          ...
          >
            {isPendingMutateDeleteEvent ? <Spinner size="sm" color="white" /> : "Delete Event"}
          </Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
