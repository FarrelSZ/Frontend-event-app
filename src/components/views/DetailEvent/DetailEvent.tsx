    ...
    <div className="px-8 md:px-0">
      ...
      <section className="mt-4 flex flex-col gap-10 lg:flex-row">
        <div className="w-full lg:w-4/6">
          <Skeleton isLoaded={!!dataEvent?.name} className="mb-2 h-8 rounded-lg">
            <h1 className="text-2xl font-semibold text-danger">{dataEvent?.name}</h1>
          </Skeleton>
          <Skeleton className="mb-2 h-6 w-1/2 rounded-lg" isLoaded={!!dataEvent?.startDate || !!dataEvent?.endDate}>
          ...
          <Skeleton className="mb-2 h-6 w-1/2 rounded-lg" isLoaded={!!dataEvent?.isOnline || !!dataEvent?.location}>
            <div className="flex items-center gap-2 text-foreground-500">
          ...
          <Skeleton className="mb-4 aspect-video w-full" isLoaded={!!dataEvent?.banner}>
            <Image
              alt="cover"
          ...
          <Tabs aria-label="Tab Detail Event" fullWidth>
            <Tab key="Description" title="Description">
              ...
              <Skeleton className="mt-2 h-32 w-full rounded-lg" isLoaded={!!dataEvent?.description}>
