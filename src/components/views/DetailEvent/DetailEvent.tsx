      ...
      <section className="mt-4 flex flex-col gap-10 lg:flex-row">
        <div className="w-full lg:w-4/6">
          <Skeleton isLoaded={!!dataEvent?.name} className="h-8 mb-2 rounded-lg">
            <h1 className="text-2xl font-bold text-danger ">{dataEvent?.name}</h1>
          </Skeleton>
          <Skeleton className="h-6 rounded-lg w-1/2 mb-2" isLoaded={!!dataEvent?.startDate || !!dataEvent?.endDate}>
            <div className="flex items-center gap-2 text-foreground-500 mb-3">
              <FaClock width={16} />
              <p>
          ...
          <Skeleton className="h-6 rounded-lg w-1/2 mb-2" isLoaded={!!dataEvent?.isOnline || !!dataEvent?.location}>
          ...
          <Skeleton className="mb-4 w-full aspect-video" isLoaded={!!dataEvent?.banner}>
            <Image
